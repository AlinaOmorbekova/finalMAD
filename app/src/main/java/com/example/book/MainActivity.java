...
import model.Book;
import recyclerView.BookAdapter;
import recyclerView.BookCallback;
...
public class MainActivity extends AppCompatActivity implements BookCallback {
    ...
    private void initmdataBooks() {
        ...
        mdata = new ArrayList<>();
        mdata.add(new Book(R.drawable.dog));
        mdata.add(new Book(R.drawable.plaha1));
        mdata.add(new Book(R.drawable.teacher));
        mdata.add(new Book(R.drawable.white));
        mdata.add(new Book(R.drawable.jamila));
        mdata.add(new Book(R.drawable.cloud));
    ...
    private void addBook() {
        ...
        Book book = new Book(R.drawable.jamila);
        mdata.add(1,book);
